...
file = './results/csv/ia/plot_result.csv'

# Abrir o arquivo e contar as linhas
with open(file, 'r') as f:
    USER = sum(1 for line in f)

# Informar a quantidade de linhas do arquivo CSV
#print(USER)
...
plt.savefig('./results/img/ai_acc_vs_time.png')
...
plt.grid()
plt.subplots_adjust(left=0.140, right=0.980, bottom=0.130, top=0.870)
plt.savefig('./results/img/ai_acc_vs_epoch.png')
